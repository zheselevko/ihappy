                <a class="mini-cart<?if ($text_items_total_price!=0){echo " full";} ?>" href="/index.php?route=checkout/cart">
        
                            <span class="count"><?php echo $text_items; ?></span>
                <?php echo $currency; ?>
          
                    <span class="total"><? echo $text_items_total_price;?><span class="cur"><?echo $text_items_cur_price;?></span></span>
                </a>
<?/*
<div id="cart">
  <div class="heading">
